    ...
    <div className="legal-page-wrapper">
      <FadeIn transitionDuration={700}>
        <div className="legal-content">
          ...
          <p>
            <strong>Phan Quang Duy</strong> ("we," "our," or "us") is committed
          ...
          <ul>
            ...
            <li>
              <strong>Local Storage:</strong> We do not store your content on
              our servers. Any data you explicitly save (such as "History" or
          ...
          <ul>
            <li>
              ...
              information about how the App performs (e.g., crash reports
              provided by Apple or Google) to help us fix bugs and improve
              stability.
            </li>
            <li>
              <strong>Device Information:</strong> We may collect generic
              information about your device model and operating system version
          ...
          <p>
            We maintain formatting and data integrity by using trusted
            third-party service providers. By using our App, you acknowledge
            that your data may be processed by these parties:
          </p>
          <ul>
            <li>
              <strong>Google Gemini API:</strong> We use Google's generative AI
              to process your text. Google may use this data to improve their
          ...
          <p>
            ...
            necessary for the purposes set out in this Privacy Policy. Input
            text sent to AI is transient and processed immediately. Since data
            saved in "History" is stored locally on your device, you have full
          ...
          <p>
            ...
            content is stored locally on your device, please ensure your device
            is secured. However, remember that no method of transmission over
